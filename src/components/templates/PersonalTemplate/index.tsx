...
import PersonalContent from "@/components/organisms/PersonalContent";
  ...
  return (
    <div className="flex flex-col min-h-screen font-sans text-text-primary bg-bg overflow-x-hidden">
      ...
      <main className="flex-grow pt-24 pb-20 relative">
        {}
        <div className="absolute top-0 left-0 w-full h-[600px] bg-gradient-to-b from-accent/5 to-transparent pointer-events-none -z-10" />
